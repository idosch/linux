...
fib_ipv4_tos_test()
{
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 tos 2 metric 1024"
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 tos 1 metric 1024"
...
fib_ipv4_metric_test()
{
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 metric 1024"
	check_err $? "Route not in hardware when should"

	ip -n $ns route add 192.0.2.0/24 dev dummy1 metric 1022
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 metric 1022"
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 metric 1023"
...
fib_ipv4_replace_test()
{
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy2 metric 1024"
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy2 metric 1024"
	check_err $? "Lowest metric route not in hardware when should"
	fib4_trap_check $ns "192.0.2.0/24 dev dummy2 metric 1025"
...
fib_ipv4_delete_test()
{
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 metric 1025"
	check_err $? "Lowest metric route not in hardware when should"
...
fib_ipv4_plen_test()
{
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1"
	check_err $? "/24 not in hardware when should"

	fib4_trap_check $ns "192.0.2.0/25 dev dummy1"
...
fib_ipv4_replay_tos_test()
{
	...
	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 tos 1"
	check_err $? "Highest TOS route not in hardware when should"

	fib4_trap_check $ns "192.0.2.0/24 dev dummy1 tos 0"
...
fib_ipv6_add_test()
{
	...
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy1 metric 1024"
	check_err $? "Route not in hardware when should"

	ip -n $ns route append 2001:db8:1::/64 dev dummy2 metric 1024
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy2 metric 1024"
	check_fail $? "Route in hardware when should not"
...
fib_ipv6_metric_test()
{
	...
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy1 metric 1022"
	check_err $? "Lowest metric route not in hardware when should"
	...
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy1 metric 1023"
	check_fail $? "Middle metric route in hardware when should not"
...
fib_ipv6_append_single_test()
{
	...
	fib6_trap_check $ns "2001:db8:10::/64 metric 1024"
	check_err $? "Route not in hardware when should"
	...
	fib6_trap_check $ns "2001:db8:10::/64 metric 1025"
	check_fail $? "Route in hardware when should not"

	ip -n $ns route append 2001:db8:10::/64 via 2001:db8:2::2 metric 1025
	fib6_trap_check $ns "2001:db8:10::/64 metric 1025"
	check_fail $? "Route in hardware when should not after appending"
...
fib_ipv6_replace_single_test()
{
	...
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy2 metric 1024"
	check_err $? "Lowest metric route not in hardware when should"
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy2 metric 1025"
	check_fail $? "Highest metric route in hardware when should not"
...
fib_ipv6_metric_multipath_test()
{
	...
	ip -n $ns route add 2001:db8:10::/64 metric 1022 \
		nexthop via 2001:db8:1::2 dev dummy1 \
		nexthop via 2001:db8:2::2 dev dummy2
	fib6_trap_check $ns "2001:db8:10::/64 metric 1022"
	check_err $? "Lowest metric route not in hardware when should"
	...
	fib6_trap_check $ns "2001:db8:10::/64 metric 1023"
	check_fail $? "Middle metric route in hardware when should not"
...
fib_ipv6_append_multipath_to_single_test()
{
	...
	fib6_trap_check $ns "2001:db8:10::/64 dev dummy1 metric 1024"
	check_err $? "Route not in hardware when should"

	ip -n $ns route append 2001:db8:10::/64 metric 1024 \
		nexthop via 2001:db8:2::2 dev dummy2
	fib6_trap_check $ns "2001:db8:10::/64 dev dummy2 metric 1024"
	check_fail $? "Route in hardware when should not"
...
fib_ipv6_delete_single_test()
{
	...
	fib6_trap_check $ns "2001:db8:10::/64 dev dummy1 metric 1025"
...
fib_ipv6_replay_single_test()
{
	...
	fib6_trap_check $ns "2001:db8:1::/64 dev dummy1"
	check_err $? "First route not in hardware when should"

	fib6_trap_check $ns "2001:db8:1::/64 dev dummy2"
	check_fail $? "Second route in hardware when should not"
