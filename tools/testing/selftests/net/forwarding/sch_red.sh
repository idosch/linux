...
{
	install_qdisc ecn
	perf_sensitive do_ecn_test $BACKLOG
	uninstall_qdisc
}
...
ecn_nodrop_test()
{
	...
	perf_sensitive do_ecn_nodrop_test $BACKLOG
	uninstall_qdisc
}
...
{
	install_qdisc
	perf_sensitive do_red_test $BACKLOG
	uninstall_qdisc
}
...
red_qevent_test()
{
	...
	perf_sensitive do_red_qevent_test $BACKLOG
	uninstall_qdisc
}
...
ecn_qevent_test()
{
	...
	perf_sensitive do_ecn_qevent_test $BACKLOG
	uninstall_qdisc
}
