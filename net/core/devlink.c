 ...
 *
 * The name of the traps are part of the kernel ABI and must have a
			 ...
			 const struct devlink_trap_metadata *metadata)
{
	...
	if (trap_item->state != DEVLINK_TRAP_STATE_REPORT)
		goto unlock;
 ...
 *
 * The name of the trap groups are part of the kernel ABI and must have a
 * corresponding entry under Documentation/ABI/.
 *
 * Return: Non-zero value on failure.
 */
