 ...
 * @file_name: Firmware image file name. Can be NULL.
 * @pass: Module password. Only valid when @pass_valid is set.
 * @run: Whether to run the currently inactive firmware or not.
 * @commit: Whether to commit the currently running firmware or not.
