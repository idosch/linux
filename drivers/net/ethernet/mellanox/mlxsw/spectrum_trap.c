...
static const struct devlink_trap_metadata_cap mlxsw_sp_trap_metadata = {
...
#define MLXSW_SP_TRAP_DROP(_id, _group_id)				      \
	DEVLINK_TRAP_GENERIC(DROP, _id, MLXSW_SP_TRAP_GROUP_NAME_##_group_id, \
			     MLXSW_SP_TRAP_GROUP_ID_##_group_id,	      \
