			  ...
			  struct netlink_ext_ack *extack)
{
	...
	mlxsw_sp->policer_bs_factor = MLXSW_REG_QPCR_CBS_FACTOR_SP1;
			  ...
			  struct netlink_ext_ack *extack)
{
	...
	mlxsw_sp->policer_bs_factor = MLXSW_REG_QPCR_CBS_FACTOR_SP2;
			  ...
			  struct netlink_ext_ack *extack)
{
	...
	mlxsw_sp->policer_bs_factor = MLXSW_REG_QPCR_CBS_FACTOR_SP3;
