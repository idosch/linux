...
#define MLXSW_PCI_FW_STATUS			0xA1844
#define MLXSW_PCI_FW_STATUS_MASK		0xFFFF
#define MLXSW_PCI_FW_STATUS_READY_MAGIC		0x5E
#define MLXSW_PCI_FW_STATUS_MAIN_READY_MAGIC	0x5D
#define MLXSW_PCI_FW_STATUS_GB_FATAL_ERR_MAGIC	0xFFB0
